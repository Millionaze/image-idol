import { Flame, LayoutDashboard, Zap, Mail, Megaphone, Inbox, LogOut, Settings, BarChart3, Mail as MailIcon, Filter, PenLine, Target, CalendarDays, ClipboardCheck, Shuffle, Users, Workflow, LayoutList } from "lucide-react";
...
const mainItems = [
  ...
  { title: "Pipeline", url: "/pipeline", icon: LayoutList },
